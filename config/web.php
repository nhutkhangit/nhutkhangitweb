...
require __DIR__ . '/../helper/ModuleHelper.php';
...
if (file_exists(__DIR__ . '/../helper/debug-var.php')){
	require_once(__DIR__ . '/../helper/debug-var.php');
}
$config = [
	'id'         => 'basic',
	...
	'components' => [
		...
		'urlManager'   => [
			...
			'rules'           => array_merge($module->moduleRouteMerge(), [
